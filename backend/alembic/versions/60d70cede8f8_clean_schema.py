...
Revision ID: 60d70cede8f8
Revises: 
Create Date: 2026-06-19 22:15:21.074209
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_universities_subdomain'), 'universities', ['subdomain'], unique=True)
...
def downgrade() -> None:
    ...
    op.drop_table('users')
    op.drop_index(op.f('ix_universities_subdomain'), table_name='universities')
